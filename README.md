...
git can run locally and (when using platforms like Github or GitLab) sync with a remote system and act like a backup. 
...
You want to avoid putting large data files in your git history, these should ideally live in a separate directory, but if you do save data in within your 
